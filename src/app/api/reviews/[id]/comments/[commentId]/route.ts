...
export async function PATCH(
  ...
  try {
    ...
    if (comment.author !== "user") {
      return NextResponse.json({ error: "Cannot edit AI-authored comments" }, { status: 403 });
    }
...
export async function DELETE(
  ...
  try {
    ...
    if (comment.author !== "user") {
      return NextResponse.json({ error: "Cannot delete AI-authored comments" }, { status: 403 });
    }
